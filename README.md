...
To run this application, run "ruby bin/run.rb" in the file directory. Don't forget to "bundle install" before running the program. Enter "bash | lolcat" in the terminal to create the rainbow-colored text effect. Enjoy!
